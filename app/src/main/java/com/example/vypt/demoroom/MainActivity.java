package com.example.vypt.demoroom;
...
import com.example.vypt.demoroom.data.UserRepository;
import com.example.vypt.demoroom.data.local.UserDatabase;
import com.example.vypt.demoroom.data.local.UserLocalDataSource;
import com.example.vypt.demoroom.data.model.Place;
...
public class MainActivity extends AppCompatActivity
    ...
    public void onClick(View view) {
        ...
        Disposable disposable = Observable.create(new ObservableOnSubscribe<Object>() {
            @Override
            public void subscribe(ObservableEmitter<Object> e) throws Exception {
                User user = new User("Pham The", " Vy " + new Random().nextInt());
                Place place = new Place("VNG " + new Random().nextInt());
                user.setPlace(place);
